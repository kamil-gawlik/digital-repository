...
var FrontendSharedLibsModule = (function () {
    function FrontendSharedLibsModule() {
    }
    FrontendSharedLibsModule = __decorate([
        core_1.NgModule({
            imports: [
    ...
    return FrontendSharedLibsModule;
}());
exports.FrontendSharedLibsModule = FrontendSharedLibsModule;
